...
class Contacts extends Resource
{
    ...
    /**
     * Grab list status for a contact
     * @see Unofficially documented, https://developers.activecampaign.com/reference#schema
     *
     * @param int $contact_id
     * @return string
     */
    public function grabLists(int $contact_id)
    {
        $req = $this->client
            ->getClient()
            ->get('/api/3/contacts/'.$contact_id.'/contactLists');
